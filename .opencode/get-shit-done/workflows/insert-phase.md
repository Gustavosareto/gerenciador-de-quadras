...
```bash
INIT=$(node "C:/Users/gusta/OneDrive/Documentos/gerenciador-de-quadras/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "C:/Users/gusta/OneDrive/Documentos/gerenciador-de-quadras/.opencode/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
