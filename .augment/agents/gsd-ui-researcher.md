...
Use template from `C:/Users/gusta/OneDrive/Documentos/gerenciador-de-quadras/.augment/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Users/gusta/OneDrive/Documentos/gerenciador-de-quadras/.augment/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "C:/Users/gusta/OneDrive/Documentos/gerenciador-de-quadras/.augment/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
