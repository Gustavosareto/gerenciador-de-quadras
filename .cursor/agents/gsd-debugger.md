...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Users/gusta/OneDrive/Documentos/gerenciador-de-quadras/.cursor
                  → checks C:/Users/gusta/OneDrive/Documentos/gerenciador-de-quadras/.cursor/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Users/gusta/OneDrive/Documentos/gerenciador-de-quadras/.cursor/get-shit-done
                  → writes to C:/Users/gusta/OneDrive/Documentos/gerenciador-de-quadras/.cursor/get-shit-done/hooks/
...
```bash
INIT=$(node "C:/Users/gusta/OneDrive/Documentos/gerenciador-de-quadras/.cursor/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "C:/Users/gusta/OneDrive/Documentos/gerenciador-de-quadras/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "C:/Users/gusta/OneDrive/Documentos/gerenciador-de-quadras/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
