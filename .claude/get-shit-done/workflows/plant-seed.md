...
```bash
node "C:/Users/gusta/OneDrive/Documentos/gerenciador-de-quadras/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: plant seed — {$IDEA}" --files .planning/seeds/SEED-{PADDED}-{slug}.md
```
</step>
