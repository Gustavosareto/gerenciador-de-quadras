...
```bash
node "C:/Users/gusta/OneDrive/Documentos/gerenciador-de-quadras/.claude/get-shit-done/bin/gsd-tools.cjs" commit "chore: archive phase directories from completed milestones" --files .planning/milestones/ .planning/phases/
```
